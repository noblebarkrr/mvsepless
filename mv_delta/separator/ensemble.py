...
def ensemble_audio_files(
    files, output="res.wav", ensemble_type="avg_wave", weights=None, out_format="wav"
):
    """
    ...
    for f in files:
        ...
        wav, current_sr = audio.read(i=f, sr=None, mono=False)
        if sr is None:
            sr = current_sr
        elif sr != current_sr:
    ...
    audio.write(o=output, array=res.T, sr=sr, of=out_format, br="320k")
    audio.write(o=output_wav, array=res.T, sr=sr, of="wav")
