models_data = {
    ...
    "mel_band_roformer": {
        ...
        "gaboxr67_instrumental_bv4": {
            "full_name": "Mel-Band Roformer Instrumental Bv4 by GaboxR67",
            "stems": ["Vocals", "Instrumental"],
            "target_instrument": "Instrumental",
            "checkpoint_url": "https://huggingface.co/GaboxR67/MelBandRoformers/resolve/main/melbandroformers/instrumental/inst_gaboxBv4.ckpt?download=true",
            "config_url": "https://huggingface.co/GaboxR67/MelBandRoformers/resolve/main/melbandroformers/instrumental/inst_gabox.yaml?download=true"
        },
        "gaboxr67_vocals_fv1": {
    ...
    "scnet": {
        ...
        "joris_jazz": {
            "full_name": "SCNet Jazz model by Joris Vaneyghen",
            "stems": ["piano", "drums", "bass", "other"],
            "target_instrument": "No",
            "checkpoint_url": "https://huggingface.co/jorisvaneyghen/SCNet/resolve/main/model_jazz_scnet.ckpt?download=true",
            "config_url": "https://huggingface.co/jorisvaneyghen/SCNet/resolve/main/config_jazz_scnet.yaml?download=true"
        }
    },
