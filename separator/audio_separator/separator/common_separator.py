...
class CommonSeparator:
    ...
    def prepare_mix(self, mix):
        ...
        if not isinstance(mix, np.ndarray):
            ...
            mix, sr = audio.read(i=mix, mono=False, sr=self.sample_rate)
            self.logger.debug(
    ...
    def write_audio(self, stem_path: str, stem_source):
        ...
        self.write_audio_ffmpeg(stem_path, stem_source)

    def write_audio_ffmpeg(self, stem_path: str, stem_source):
        """
        ...
        try:
            audio.write(
                o=stem_path, array=stem_source, sr=self.sample_rate, of=file_format, br=bitrate
            )
