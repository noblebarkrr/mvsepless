    ...
    def separate(self, audio_file_path, custom_output_names=None):
        ...
        if isinstance(source, dict):
            ...
            if not self.output_single_stem or self.output_single_stem.lower() == self.secondary_stem_name.lower():
                ...
                output_files.append((self.secondary_stem_name, os.path.join(self.output_dir, self.secondary_stem_output_path)))
        ...
        if not isinstance(source, dict) or not self.output_single_stem or self.output_single_stem.lower() == self.primary_stem_name.lower():
            ...
            output_files.append((self.primary_stem_name, os.path.join(self.output_dir, self.primary_stem_output_path)))
