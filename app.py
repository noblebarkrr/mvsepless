    ...
    with gr.Tab(t("separation")):
        with gr.Row():
            ...
            with gr.Column():
                ...
                stems_list = gr.CheckboxGroup(label=t("stems_list"), choices=mvsepless.get_stems(mvsepless.get_mt()[0], mvsepless.get_mn(mvsepless.get_mt()[0])[0]), value=None, interactive=False)
                with gr.Row():
