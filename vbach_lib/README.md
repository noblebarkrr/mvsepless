...
## Шаблон имени файла <a id="шаблон-имени"></a>
...
## Доступные методы извлечения F0 <a id="методы-f0"></a>
...
## Формат данных в JSON-файле кривой F0: <a id="формат-данных-f0"></a>
...
## Стерео-режимы <a id="стерео-режимы-обработки"></a>
...
## 🎤 Пример использования <a id="пример-использования"></a>

### Извлечение F0 кривой <a id="извлечение-f0-кривой-использование"></a>
...
### Преобразование вокала <a id="преобразование-вокала-использование"></a>
...
### Преобразование вокала с кастомной F0 кривой <a id="преобразование-вокала-с-кастомной-f0-кривой-использование"></a>
...
### Загрузка модели эмбеддера <a id="загрузка-модели-эмбеддера-использование"></a>
...
## 📋 Параметры методов <a id="параметры-методов"></a>

### `f0_extract_and_write()` <a id="извлечение-f0-кривой-метод"></a>
...
### `VbachConverter().convert_audio()` <a id="преобразование-вокала-метод"></a>
...
### `VbachConverter().convert_audio_custom_f0()` <a id="преобразование-вокала-с-кастомной-f0-кривой-метод"></a>
...
### `download_hubert()` <a id="загрузка-модели-эмбеддера-метод"></a>
...
## Все параметры командной строки <a id="параметры-командной-строки"></a>

### Извлечение F0 кривой <a id="извлечение-f0-кривой-cli"></a>
...
### Преобразование вокала <a id="преобразование-вокала-cli"></a>
...
### Преобразование вокала с кастомной F0 кривой <a id="преобразование-вокала-с-кастомной-f0-кривой-cli"></a>
...
### Загрузка модели эмбеддера <a id="загрузка-модели-эмбеддера-cli"></a>
